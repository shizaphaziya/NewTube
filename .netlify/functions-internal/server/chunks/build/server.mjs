...
import { hasInjectionContext, inject, toRef, isRef, computed, getCurrentInstance as getCurrentInstance$1, shallowRef, defineComponent, createElementBlock, provide, cloneVNode, h, toValue, onServerPrefetch, reactive, useSlots, Fragment, defineAsyncComponent, unref, shallowReactive, ref, Suspense, createApp, createVNode, Text, toRaw, onErrorCaptured, resolveDynamicComponent, effectScope, nextTick, watch, mergeProps, getCurrentScope, withCtx, onScopeDispose, isReadonly, useSSRContext, isShallow, isReactive, customRef } from 'vue';
import { t as parseURL, v as encodePath, w as decodePath, x as hasProtocol, y as isScriptProtocol, r as joinURL, z as withQuery, A as sanitizeStatusCode, B as getContext, $ as $fetch$1, C as baseURL, D as hash, E as defu, m as createError$1, F as executeAsync, G as getHeader, H as getRequestURL, I as setCookie, J as setHeader, K as getRequestHeader, L as getCookie, M as klona, N as parse$2, O as isEqual, P as createDefu, Q as parsePath, R as parseQuery, S as deleteCookie, T as withoutTrailingSlash, U as isEqual$1 } from '../nitro/nitro.mjs';
...
const unhead_1_8AwvYI6_6XedXqUeafNDzMuofLjSTNrCH9628ysjA = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "auth-confirm___ru",
    path: "/auth/confirm",
    component: () => import('./confirm-TqqDGmrI.mjs')
  },
  {
    name: "auth-confirm___en",
    path: "/en/auth/confirm",
    component: () => import('./confirm-TqqDGmrI.mjs')
  },
  {
    ...
    component: () => import('./login-3uMuLDyh.mjs')
  },
  {
  ...
  {
    name: "studio-upload___ru",
    path: "/studio/upload",
    component: () => import('./upload-CcJYy160.mjs')
  },
  {
    name: "studio-upload___en",
    path: "/en/studio/upload",
    component: () => import('./upload-CcJYy160.mjs')
  },
  {
    name: "watch-id___ru",
    path: "/watch/:id()",
    component: () => import('./_id_-Bjw0M2Ps.mjs')
  },
  {
    name: "watch-id___en",
    path: "/en/watch/:id()",
  ...
  },
  {
    ...
    component: () => import('./index-Dp4pT9JZ.mjs')
  },
  {
    name: "admin___en",
    path: "/en/admin",
  ...
  },
  {
    name: "studio___ru",
    path: "/studio",
    component: () => import('./index-CjhX8-AH.mjs')
  },
  {
    name: "studio___en",
    path: "/en/studio",
  ...
  },
  {
    name: "index___ru",
    path: "/",
    component: () => import('./index-Bo_ph3n8.mjs')
  },
  {
    name: "index___en",
    path: "/en",
...
const namedMiddleware = {
  admin: () => import('./admin-DMHQrSaB.mjs')
};
  ...
  const client = createClient(supabaseUrl, supabaseKey, {
    ...
    global: {
      ...
      headers: {
        ...
        "X-Client-Info": `supabase-ssr/${VERSION$2} createServerClient`
      }
    },
    auth: {
...
const supabase_server_zh_ygqBOS2V_j7UaocMyROXkHoRfgjHyKTFfivIOQ6I = /* @__PURE__ */ defineNuxtPlugin({
  name: "supabase",
  enforce: "pre",
...
const revive_payload_server_1QHFLe86C3Fqo1Nx7SIFZfbsYQAhMDr2BQIU6Ej2P3g = /* @__PURE__ */ defineNuxtPlugin({
...
function resolveRootRedirect(config) {
  ...
  return {
    path: "/" + (isString$1(config) ? config : config.path).replace(/^\//, ""),
    code: !isString$1(config) && config.statusCode || 302
  };
}
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/7wlHAXwU"}/${locale}/messages.json`, { headers });
  ...
  const ctx = {
    ...
    getLocales: () => unref(i18n.locales).map((x) => isString$1(x) ? { code: x } : x),
...
function datetime(context, ...args) {
  ...
  if (!isString$1(args[0]) && !isDate(args[0]) && !isNumber(args[0])) {
...
function createMessageContext(options = {}) {
  ...
  const pluralRule = isString$1(locale) && isFunction(options.pluralRules?.[locale]) ? options.pluralRules[locale] : pluralDefault;
  ...
  const interpolate2 = isFunction(options.processor?.interpolate) ? options.processor.interpolate : DEFAULT_INTERPOLATE;
  const type = isString$1(options.processor?.type) ? options.processor.type : DEFAULT_MESSAGE_DATA_TYPE;
  const linked = (key, ...args) => {
    ...
    const msg = (
      ...
      type2 === "vnode" && isArray$1(resolved) && modifier ? resolved[0] : resolved
    );
...
function createComposer(options = {}) {
  ...
  function n(...args) {
    return wrapWithDeps((context) => Reflect.apply(number$1, null, [context, ...args]), () => parseNumberArgs(...args), "number format", (root) => Reflect.apply(root.n, root, [...args]), () => MISSING_RESOLVE_VALUE, (val) => isString$1(val) || isArray$1(val));
  }
  ...
  function te(key, locale2) {
    return wrapWithDeps(() => {
      ...
      const locales = isString$1(locale2) ? [targetLocale] : fallbackWithLocaleChain(_context, _fallbackLocale.value, targetLocale);
      for (let i = 0; i < locales.length; i++) {
        ...
        if (isMessageAST(resolved) || isMessageFunction(resolved) || isString$1(resolved)) {
          return true;
        }
      }
      return false;
...
const switch_locale_path_ssr_CxEoExrzOK_woaOGfQfcYmSrtNU_WvSw2hjv6OaFHNA = /* @__PURE__ */ defineNuxtPlugin({
...
const route_locale_detect_lc07KFs8ozM_TF6FLtV8qNCxS1vzF_2HPtP4ldVMPFU = /* @__PURE__ */ defineNuxtPlugin({
...
const preload_LpDSKtXzftk6_SzlYBH3TeBw0GDCsaNzinaSXDL_tg0 = /* @__PURE__ */ defineNuxtPlugin({
...
const i18n_ajllDKNN0fYvjYMfwzflwDgYXOA_tGM5PyCYo5X0GRI = /* @__PURE__ */ defineNuxtPlugin({
  name: "i18n:plugin",
  parallel: false,
  async setup(_nuxt) {
    let __temp, __restore;
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/7wlHAXwU"}/${locale}/messages.json`));
...
const motion_F_7a03MnEQf9y4r0lyvAxSGm9SnUscHkr_JDA88JkvE = /* @__PURE__ */ defineNuxtPlugin(
  (nuxtApp) => {
...
const auth_redirect_0mVGkPrTXGQ5tZp3poZwwJoJiCJbxDjzIfnL9f0Wv4Y = /* @__PURE__ */ defineNuxtPlugin({
  name: "auth-redirect",
  setup() {
    addRouteMiddleware(
      "global-auth",
...
const ssg_detect_vvW2SVGqJH8DQoUaxQIu0x7EdkMmG6Nw7yzLlWAOgdE = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_1_8AwvYI6_6XedXqUeafNDzMuofLjSTNrCH9628ysjA,
  plugin,
  supabase_server_zh_ygqBOS2V_j7UaocMyROXkHoRfgjHyKTFfivIOQ6I,
  revive_payload_server_1QHFLe86C3Fqo1Nx7SIFZfbsYQAhMDr2BQIU6Ej2P3g,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  switch_locale_path_ssr_CxEoExrzOK_woaOGfQfcYmSrtNU_WvSw2hjv6OaFHNA,
  route_locale_detect_lc07KFs8ozM_TF6FLtV8qNCxS1vzF_2HPtP4ldVMPFU,
  preload_LpDSKtXzftk6_SzlYBH3TeBw0GDCsaNzinaSXDL_tg0,
  i18n_ajllDKNN0fYvjYMfwzflwDgYXOA_tGM5PyCYo5X0GRI,
  motion_F_7a03MnEQf9y4r0lyvAxSGm9SnUscHkr_JDA88JkvE,
  unocss_6Z4vW7S9aX_q2svWbGBc_X2b5QbQdkNmvzr_3kqqCd0,
  auth_redirect_0mVGkPrTXGQ5tZp3poZwwJoJiCJbxDjzIfnL9f0Wv4Y,
  ssg_detect_vvW2SVGqJH8DQoUaxQIu0x7EdkMmG6Nw7yzLlWAOgdE
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-C3a5LIlQ.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CrWbr-4u.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CHEAoNS2.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.2_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@emna_166905cb3e2aca86c7481b892fc8e5bb/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.2_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@emna_166905cb3e2aca86c7481b892fc8e5bb/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useSupabaseUser as a, useI18n as b, useRoute as c, useAsyncData as d, entry_default as default, useSeoMeta as e, defineNuxtRouteMiddleware as f, useRouter as g, encodeRoutePath as h, useNuxtApp as i, useRuntimeConfig as j, nuxtLinkDefaults as k, useState as l, navigateTo as n, resolveRouteObject as r, useHead as u };
