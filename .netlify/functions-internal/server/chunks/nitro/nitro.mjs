...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "86850fc2-7372-4d64-93b1-951e0db7adfd",
...
var watch$1 = {
	...
	impression_units: "Единицы просмотра",
	logged: "Опубликовано",
	up_next: "Далее",
	verified_architect: "Верифицированный автор",
	membership_active: "Подписка активна",
	join_collective: "Подписаться",
	no_metadata: "Описание отсутствует.",
	protocol_feed: "Комментарии",
	analytics_units: "просм."
};
var studio$1 = {
	command_center: "Центр управления",
	elite_operator: "Элитный оператор",
	publish_record: "Опубликовать",
	total_impressions: "Всего просмотров",
	signal_fragments: "Видеозаписи",
	synapse_response: "Реакции",
	active_records: "Активные записи",
	no_records: "Видеозаписи не найдены.",
	impressions: "просмотров",
	terminate_confirm: "Вы уверены, что хотите удалить эту запись?",
	upload: "Публикация контента",
	title: "Название потока",
	description: "Метаданные и описание",
	select_file: "Выбрать мастер-файл",
	cover_artwork: "Обложка и арт",
	select_thumbnail: "Выбрать превью",
	processing_signal: "Оптимизация сигнала",
	cinematic_protocols: "Применение протоколов сжатия",
	broadcasting: "Вещание данных",
	streaming_nodes: "Потоковая передача на узлы хранения",
	processing: "Обработка",
	uploading: "Загрузка",
	publish: "Опубликовать контент",
	success: "Трансляция установлена!",
	success_subtitle: "Развертывание завершено успешно",
	entry_name_placeholder: "ИМЯ ЗАПИСИ",
	description_placeholder: "Данные контента и описание метаданных...",
	optimizing: "Оптимизация сигнала",
	ffmpeg_note: "Применение протоколов сжатия",
	uploading_note: "Потоковая передача на узлы хранения"
};
var admin$1 = {
...
var auth$1 = {
	...
	subtitle: "Новое измерение видео контента",
	email: "Эл. почта",
	password: "Пароль",
	sign_in: "Войти",
	sign_up: "Регистрация",
	...
	authentication_locked: "Доступ закрыт",
	auth_required_desc: "Студия доступна только авторизованным пользователям.",
	authorize_identity: "Войти в систему"
};
const locale_ru_46json_f9c37154 = {
	nav: nav$1,
	home: home$1,
	watch: watch$1,
	studio: studio$1,
...
var watch = {
	...
	impression_units: "Impression Units",
	logged: "Logged",
	up_next: "Up Next",
	verified_architect: "Verified Architect",
	membership_active: "Membership Active",
	join_collective: "Join Collective",
	no_metadata: "No detailed metadata available.",
	protocol_feed: "Protocol: Feed",
	analytics_units: "Units"
};
var studio = {
	...
	signal_fragments: "Signal Fragments",
	synapse_response: "Synapse Response",
	active_records: "Active Records",
	no_records: "No signal fragments identified.",
	impressions: "Impressions",
	terminate_confirm: "Are you absolutely sure you want to terminate this record?",
	upload: "Publish Content",
	title: "Stream Title",
	description: "Metadata & Description",
	select_file: "Select Master File",
	cover_artwork: "Cover Artwork",
	select_thumbnail: "Select Thumbnail",
	processing_signal: "Optimizing Signal",
	cinematic_protocols: "Applying cinematic compression protocols",
	broadcasting: "Broadcasting Content",
	streaming_nodes: "Streaming master file to secure nodes",
	processing: "Processing",
	uploading: "Uploading",
	publish: "Publish Content",
	success: "Broadcast Established!",
	success_subtitle: "Deployment Successful • Redirecting",
	entry_name_placeholder: "ENTRY NAME",
	description_placeholder: "Content data and metadata description...",
	optimizing: "Optimizing Signal",
	ffmpeg_note: "Applying cinematic compression",
	uploading_note: "Streaming to secure storage nodes"
};
var admin = {
...
var auth = {
	...
	subtitle: "A new dimension of video content",
	email: "Email",
	password: "Password",
	sign_in: "Sign In",
	sign_up: "Sign Up",
	...
	auth_required_desc: "The Elite Studio requires validated credentials to access content management protocols.",
	authorize_identity: "Authorize Identity"
};
  ...
  ru: [
    {
      ...
      load: () => Promise.resolve(locale_ru_46json_f9c37154),
      cache: true
    }
  ],
  en: [
...
const _p7kw1JPn7uXo6dG58RXQ9C_nspDC51tZpWZxRCMwTrg = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async (context) => {
    ...
    if (!url.pathname.includes("/_i18n/7wlHAXwU") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _p7kw1JPn7uXo6dG58RXQ9C_nspDC51tZpWZxRCMwTrg
];
...
const _U0_YOQ = _messagesHandlerCached;

const _lazy_WDpgy_ = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_WDpgy_, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _U0_YOQ, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_WDpgy_, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, sanitizeStatusCode as A, getContext as B, baseURL as C, hash$1 as D, defu as E, executeAsync as F, getHeader as G, getRequestURL as H, setCookie as I, setHeader as J, getRequestHeader as K, getCookie as L, klona as M, parse as N, isEqual as O, createDefu as P, parsePath as Q, parseQuery as R, deleteCookie as S, withoutTrailingSlash as T, isEqual$1 as U, withTrailingSlash as V, handler as W, appRootTag as a, appRootAttrs as b, buildAssetsURL as c, appSpaLoaderTag as d, appSpaLoaderAttrs as e, getResponseStatus as f, getResponseStatusText as g, appId as h, defineRenderHandler as i, appTeleportTag as j, appTeleportAttrs as k, getQuery as l, createError$1 as m, appHead as n, destr as o, publicAssetsURL as p, getRouteRules as q, joinURL as r, useNitroApp as s, parseURL as t, useRuntimeConfig as u, encodePath as v, decodePath as w, hasProtocol as x, isScriptProtocol as y, withQuery as z };
