  ...
  <div class="px-4 md:px-10 py-6 md:py-10 relative">
    ...
    <div v-else class="space-y-16">
      ...
      <div class="space-y-2">
        ...
        <p
          class="text-[10px] font-black text-white/20 uppercase tracking-[0.5em]"
        >
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="glass-card p-6 border-white/5 space-y-1">
          ...
          <div class="text-3xl font-brand font-black text-white tabular-nums">
            {{ videos?.length || 0 }}
          </div>
        </div>
        <div class="glass-card p-6 border-white/5 space-y-1">
          <div
            class="text-[8px] font-black text-emerald-500/40 uppercase tracking-widest"
          >
            {{ $t("admin.active") }}
          </div>
          <div
            class="text-3xl font-brand font-black text-emerald-400 tabular-nums"
          >
        ...
        <div class="glass-card p-6 border-white/5 space-y-1">
          <div
            class="text-[8px] font-black text-red-500/40 uppercase tracking-widest"
          >
            {{ $t("admin.blocked") }}
          </div>
          ...
          <table class="w-full text-left border-collapse">
            <thead>
              <tr class="border-b border-white/5 bg-white/[0.02]">
                <th
                  class="px-6 py-4 text-[9px] font-black text-white/30 uppercase tracking-widest"
                >
                ...
                <th
                  class="px-6 py-4 text-[9px] font-black text-white/30 uppercase tracking-widest text-right"
                >
                  {{ $t("admin.actions") }}
                </th>
              </tr>
              ...
              >
                <td class="px-6 py-6">
                  <div class="flex items-center gap-4">
                    <div
                      class="w-20 aspect-video rounded-lg overflow-hidden bg-void-card border border-white/5"
                    >
                      <img
                      ...
                      <div
                        v-else
                        class="w-full h-full flex items-center justify-center opacity-20 bg-white/5"
                      >
                        <Icon
                          name="ph:video-camera-bold"
                    ...
                    <div class="space-y-1">
                      <div
                        class="text-xs font-bold text-white group-hover:text-white transition-colors"
                      >
                        {{ video.title }}
                      </div>
                      <div
                        class="text-[9px] text-white/30 uppercase tracking-wider font-medium"
                      >
                        {{
                          video.profiles?.display_name || $t("admin.anonymous")
                        }}
                      </div>
                    </div>
                  </div>
                ...
                <td class="px-6 py-6">
                  <div
                    class="text-[10px] font-black text-white/40 tabular-nums uppercase tracking-widest"
                  >
                    {{ (video.view_count || 0).toLocaleString(locale) }}
                    {{ $t("admin.imps") }}
                  </div>
                </td>
                <td class="px-6 py-6">
                  ...
                  >
                    <div
                      ...
                      :class="
                        video.is_18_plus ? 'translate-x-6' : 'translate-x-0'
                      "
                    ></div>
                  </button>
                </td>
                  ...
                  <span
                    ...
                    :class="
                      video.status === 'blocked'
                        ...
                        : 'border-emerald-500/20 text-emerald-400 bg-emerald-400/5'
                    "
                  >
                ...
                <td class="px-6 py-6 text-right">
                  <div
                    class="flex items-center justify-end gap-2 text-void-silver"
                  >
                    <button
                    ...
                    >
                      <Icon name="ph:arrow-square-out-bold" class="" />
                    </NuxtLink>
                  </div>
                </td>
              </tr>
