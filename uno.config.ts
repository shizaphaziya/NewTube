...
export default defineConfig({
  shortcuts: [
    ...
    ['glass-card', 'bg-white/[0.03] backdrop-blur-2xl border border-white/[0.07] rounded-3xl transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]'],
    ['glass-input', 'bg-white/[0.04] border border-white/[0.08] rounded-xl px-5 py-3.5 text-white placeholder:text-white/20 transition-all duration-300 focus:outline-none focus:ring-1 focus:ring-white/25 focus:bg-white/[0.06]'],
    ...
    ['surface-elevated', 'bg-[#121214] border border-white/[0.06] rounded-2xl'],
